...
%prep
%setup -q -n tblib-1.6.0
cd %{_builddir}/tblib-1.6.0
...
cp %{_builddir}/tblib-1.6.0/LICENSE %{buildroot}/usr/share/package-licenses/tblib/77a5041738487df2388bbad74d9624f613500069
